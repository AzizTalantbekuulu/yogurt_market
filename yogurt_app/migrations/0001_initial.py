    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to='C:\\Users\\Kalyibek\\PycharmProjects\\alatoo_project\\media\\images')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('city', models.CharField(default='Bishkek', max_length=55, null=True)),
                ...
                ('yogurt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='yogurt_app.yogurt')),
            ],
        ),
    ]
